...
const myExperience = [
  {
    id: 1,
    logo: '/iit-delhi-logo.png', // You'll need to add this image
    company: "GATICIAN, IIT Delhi",
    link: "https://iitdelhi.ac.in",
    label: "Full-time",
    year: "Apr 2025 - Present",
    title: "Full Stack Intern",
    description: "Built 15+ responsive React.js components serving 500+ daily users. Integrated 8 RESTful APIs and developed analytics dashboard processing 10,000+ data points, reducing report generation time by 60%. Optimized website performance achieving 50+ Lighthouse score."
  },
  {
    id: 2,
    logo: '/gdsc-logo.png', // You'll need to add this image
